/*
    ...
    OpenGL, OpenGL ES loader generated by glad 0.1.36 on Thu Mar 14 01:20:45 2024.
    ...
    Commandline:
        --profile="compatibility" --api="gl=3.1,gles2=3.1" --generator="c" --spec="gl" --local-files --extensions=""
    Online:
...
int gladLoadGLLoader(GLADloadproc load) {
	...
	printf("GL %u.%u functions loaded.\n", GLVersion.major, GLVersion.minor);
